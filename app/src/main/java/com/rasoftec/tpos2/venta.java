...
//        }
    ...
    private void forma_pago(final String descripcion, Double total_actual) {
        ...
        if (estado == 3) {
            ...
            builder.setTitle("Elegir Tipo de Pago")
...
//                            if (pos[which].toString().toLowerCase().equals("credito")) {
//                                abono_actual(descripcion2, total, pos[which].toString());
//
//
//                            } else {
                            operacion_venta(descripcion2, total, pos[which].toString());
//                            }
                            dialog.dismiss();
    ...
    private void operacion_venta(String descripcion, Double total_actual, String tipo) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                .setTitle("Total es" + " " + "Q" + " " + venta_detalle.round(total_actual, 2))
                .setMessage(descripcion + "NIT: " + CustomerNit + "\nNOMBRE: "+CustomerName);
...
//    private void movimiento(ArrayList<nodo_producto> carrito) {
//        base.insert_venta(carrito,actual,codigo);
////        base.get_movimiento();
//    }
...
//                })
        ...
        codigo.setText("Por el Momento no se Cuenta con Internet para Iniciar el Sistema ");
        ...
        builder.setPositiveButton(DialogButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (isName) {
                    ...
                    CustomerNit = input.getText().toString();
            }
        });
        builder.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
            @Override
